        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="md:flex">
              <div className="md:w-1/2 bg-teal-800 text-white p-8 md:p-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <address className="mt-2 not-italic text-teal-100">
              ...
              <div className="md:w-1/2 p-8 md:p-12">
                {submitted ? (
                  <div className="text-center py-12">
                    <svg className="w-16 h-16 text-green-500 mx-auto mb-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button 
                      ...
                      className="mt-8 bg-teal-600 hover:bg-teal-700 text-white py-2 px-6 rounded transition-colors duration-300"
                    >
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                        <div>
                          ...
                          <div className="mt-1">
                            <input
                              ...
                              className="block w-full px-4 py-3 rounded-md border-gray-300 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                            />
                          </div>
                        </div>
                        <div>
                        ...
                        <div className="sm:col-span-2">
                          <button
                            type="submit"
                            className="w-full bg-teal-600 hover:bg-teal-700 text-white py-3 px-6 rounded shadow-md transition-colors duration-300"
                          >
                            Send Message
                          </button>
                        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-serif font-bold text-gray-900 mb-4">Find Us</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-medium">By Sea</h4>
                  <p className="text-gray-600">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            ...
            <button className="bg-teal-600 hover:bg-teal-700 text-white py-3 px-8 rounded shadow-md transition-colors duration-300">
              Ask a Question
            </button>
          </div>
        </div>
