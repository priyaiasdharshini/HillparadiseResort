    ...
    <div className="bg-gray-900">
      ...
      <div className="relative pt-24 pb-12 md:pt-32 md:pb-24 overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-amber-100 mb-4 tracking-tight">
            Contact Us
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-emerald-700/30">
            <div className="md:flex">
              <div className="md:w-1/2 bg-emerald-950 text-amber-100 p-8 md:p-12">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-emerald-700 p-2 rounded-full">
                      <svg className="w-6 h-6 text-amber-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                      </svg>
                    </div>
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-amber-100">Address</h3>
                      <address className="mt-2 not-italic text-amber-200">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-amber-100">Phone</h3>
                      <p className="mt-2 text-amber-200">
                        <a href="tel:8848356964" className="hover:text-amber-100">8848356964</a>
                      </p>
                      <p className="mt-1 text-amber-200">
                        <a href="tel:9446449526" className="hover:text-amber-100">9446449526</a>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-amber-100">Email</h3>
                      <p className="mt-2 text-amber-200">
                        <a href="mailto:info@hillparadiseresort.com" className="hover:text-amber-100">info@paradiseresort.com</a>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-10">
                  <h3 className="text-lg font-medium text-amber-100 mb-4">Follow Us</h3>
                  <div className="flex space-x-4">
                    <a href="#" className="bg-emerald-700 p-2 rounded-full hover:bg-emerald-600 transition-colors duration-300">
              ...
              <div className="md:w-1/2 p-8 md:p-12 bg-gray-800">
                {submitted ? (
                  <div className="text-center py-12">
                    <svg className="w-16 h-16 text-emerald-400 mx-auto mb-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button 
                      ...
                      className="mt-8 bg-emerald-600 hover:bg-emerald-500 text-amber-100 py-2 px-6 rounded transition-colors duration-300"
                    >
                  ...
                  <>
                    <h2 className="text-2xl font-display font-bold text-amber-100 mb-6 tracking-wide">Send Us a Message</h2>
                    <form onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                        <div>
                          ...
                          <div className="mt-1">
                            <input
                              ...
                              className="block w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900 text-amber-100 shadow-sm focus:border-emerald-500 focus:ring-emerald-500"
                            />
                          </div>
                        </div>
                        <div>
                        ...
                        <div className="sm:col-span-2">
                          <button
                            type="submit"
                            className="w-full bg-emerald-600 hover:bg-emerald-500 text-amber-100 py-3 px-6 rounded shadow-md transition-colors duration-300"
                          >
                            Send Message
                          </button>
                        </div>
      ...
      <section className="py-12 md:py-16 bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-amber-100 mb-4 tracking-wide">Find Us</h2>
          ...
          <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden border border-emerald-700/30">
            <div className="h-96 bg-gray-700">
              ...
              <div className="h-full w-full flex items-center justify-center bg-gray-700">
                <p className="text-amber-200 text-lg">Interactive Map Would Be Displayed Here</p>
              </div>
            </div>
            <div className="p-6">
              <h3 className="text-lg font-semibold text-amber-100 mb-2">Getting Here</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-amber-100">By Air</h4>
                  <p className="text-amber-200">
                    The nearest international airport is 45 minutes away by car. We offer complimentary airport transfers for all guests.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-amber-100">By Sea</h4>
                  <p className="text-amber-200">
      ...
      <section className="py-12 md:py-16 bg-gradient-to-b from-emerald-950 to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-amber-100 mb-4 tracking-wide">Frequently Asked Questions</h2>
            <p className="text-base sm:text-lg text-amber-200 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              ...
              <div key={index} className="bg-gray-800 rounded-lg shadow-lg p-6 border border-emerald-700/30">
                <h3 className="text-lg font-semibold text-amber-100 mb-3">{faq.question}</h3>
          ...
          <div className="mt-12 text-center">
            ...
            <button className="bg-emerald-600 hover:bg-emerald-500 text-amber-100 py-3 px-8 rounded shadow-md transition-colors duration-300">
              Ask a Question
            </button>
          </div>
        </div>
